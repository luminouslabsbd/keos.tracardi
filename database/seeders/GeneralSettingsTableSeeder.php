...
class GeneralSettingsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $currency = [];
        // basic info
        GeneralSettings::create(['slug' => 'app_title', 'value' => 'Eg_Jobs']);
        ...
        GeneralSettings::create(['slug' => 'copy_right_text', 'value' => 'Copy right Egens Lab']);
        ...
        GeneralSettings::create(['slug' => 'currency', 'value' => 'Eg_Jobs']);
