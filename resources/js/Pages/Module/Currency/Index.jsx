...
function Index() {
    ...
    return (
        <>
            ...
            <DeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Currency" route="currency"></DeleteModal>
        </>
    );
}
