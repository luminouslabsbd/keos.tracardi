            ...
            <div className="panel">
                ...
                <div className="createuser-form">
                    <div className="w-full mx-auto">
                        <form onSubmit={handleSubmit} className="bg-white dark:bg-[#0E1726] shadow-md rounded px-8 pt-6 pb-8 mb-4">
                            <input
                            ...
                            />
                            <select
                                className="dark:bg-[#0E1726] dark:text-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                name="module_id"
                                id="module_id"
                            ...
                            <div className="flex items-center justify-end">
                                <button
                                    className="bg-[#ff6243] hover:bg-[#ff6243] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                                    type="submit"
                                >
                                    Update
                                </button>
