...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/size/trashed/data', base_url);
    ...
    function handleUndoClick(data) {
        router.get("/admin/size/undo-trashed/"+data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/size/restore-all`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/size/permanent-delete-all`}
                        method="get"
            ...
            <ParmanentDeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Size" route="size/permanent-delete"></ParmanentDeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title="Size Trashed List || Luminous-Ecommerce" />
);
