...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/size/data', base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/size/edit/"+data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/size/status/"+data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/size/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/size/create`}
                        method="get"
            ...
            <DeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Size" route="size"></DeleteModal>
        </>
    );
}
