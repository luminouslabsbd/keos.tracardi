...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/blog-category/data', base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/blog-category/edit/" + data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/blog-category/status/" + data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/blog-category/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/blog-category/create`}
                        method="get"
            ...
            <DeleteModal isDeleteNoteModal={isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Blog Category" route="blog-category"></DeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title="Luminous-Ecommerce || All Blogs" />
);
