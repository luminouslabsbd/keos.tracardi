...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/unit/trashed/data', base_url);
    ...
    function handleUndoClick(data) {
        router.get("/admin/unit/undo-trashed/"+data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/unit/restore-all`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/unit/permanent-delete-all`}
                        method="get"
            ...
            <ParmanentDeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Unit" route="unit/permanent-delete"></ParmanentDeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title="Unit Trashed List || Luminous-Ecommerce" />
);
