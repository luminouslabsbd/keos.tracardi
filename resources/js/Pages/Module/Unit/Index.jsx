...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/unit/data', base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/unit/edit/"+data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/unit/status/"+data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/unit/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/unit/create`}
                        method="get"
            ...
            <DeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Unit" route="unit"></DeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title=" Luminous-Ecommerce || Unit List" />
);
