...
function Add() {
    ...
    const [selectedImage, setSelectedImage] = useState(result?.icon ? `/storage/brand/${result?.icon}` : '/assets/images/user-profile.jpeg');
    ...
    function onSubmit(data) {
        // console.log(data);
        router.post("/admin/language/update", data);
    }
    return (
        <>
