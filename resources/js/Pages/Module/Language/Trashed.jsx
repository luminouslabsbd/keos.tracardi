...
function Index() {
    ...
    return (
        <>
            ...
            <ParmanentDeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Brand" route="brand/permanent-delete"></ParmanentDeleteModal>
        </>
    );
}
