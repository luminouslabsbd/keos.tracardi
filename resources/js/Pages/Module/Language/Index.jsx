...
function Index() {
    ...
    const ImageRenderer = ({ data }) => {
        return (
            <div>
                <img
                    src={data ? `/storage/language/${data}` : '/assets/images/user-profile.jpeg'}
                    alt="image"
    ...
    return (
        <>
            ...
            <DeleteModal isDeleteNoteModal={isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Language" route="language"></DeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title="Language List || Luminous-Ecommerce" />
);
