            ...
            },
            {
                ...
                Cell: ({ row }) => (
                    <div className="flex items-center gap-2">
                        <button onClick={() => handleEditClick(1)} className="btn btn-sm btn-outline-primary">
                            Edit
                        </button>
                        <button onClick={() => handleDeleteClick(1)} className="btn btn-sm btn-outline-danger">
                            Delete
                        </button>
                        <button onClick={() => handleCustomAction(1)} className="btn btn-sm btn-outline-warning">
                            Status
                        </button>
                    </div>
                ),
