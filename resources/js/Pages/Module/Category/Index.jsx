...
function Index() {
    ...
    return (
        <>
            <div className="category-header grid grid-cols-12 gap-4">
                    ...
                    <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                        ...
                        <div className="ml-auto flex justify-center items-center gap-3">
                            <Link
                                ...
                                method="get"
                                className="flex items-center px-3 py-2 bg-danger text-white rounded-md text-[15px] shadow-lg transition-transform transform-gpu hover:scale-105">
                            ...
                            <Link
                                ...
                                method="get"
                                className="flex items-center px-3 py-2 btn-success text-white rounded-md text-[15px] shadow-lg transition-transform transform-gpu hover:scale-105">
