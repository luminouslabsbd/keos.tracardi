...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/slider/data', base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/slider/edit/"+data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/slider/status/"+data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/slider/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/slider/create`}
                        method="get"
            ...
            <DeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Slider" route="slider"></DeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title="Unit List || Luminous-Ecommerce" />
);
