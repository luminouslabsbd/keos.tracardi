...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/slider/trashed/data', base_url);
    ...
    function handleUndoClick(data) {
        router.get("/admin/slider/undo-trashed/"+data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/slider/restore-all`}
                        method="get"
            ...
            <ParmanentDeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Slider" route="slider/permanent-delete"></ParmanentDeleteModal>
        </>
    );
}
