...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/color/trashed/data', base_url);
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/color/restore-all`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/color/permanent-delete-all`}
                        method="get"
...
Index.layout = (page) => (
    <MainLayout children={page} title="Color Trashed List || Luminous-Ecommerce" />
);
