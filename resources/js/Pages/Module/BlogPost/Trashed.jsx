...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/blog-post/trashed/data', base_url);
    ...
    function handleUndoClick(data) {
        router.get("/admin/blog-post/undo-trashed/" + data);
    }
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/blog-post/restore-all`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/blog-post/permanent-delete-all`}
                        method="get"
            ...
            <ParmanentDeleteModal isDeleteNoteModal={isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="blog-post" route="blog-post/permanent-delete"></ParmanentDeleteModal>
        </>
    );
}
