...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/blog-post/data', base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/blog-post/edit/" + data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/blog-post/status/" + data);
    }
    const ImageRenderer = ({ data }) => {
        return (
            <div>
                <img
                    src={data ? `/storage/blog_post/${data}` : '/assets/images/user-profile.jpeg'}
                    alt="image"
        ...
        <>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/blog-post/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/blog-post/create`}
                        method="get"
            ...
            <DeleteModal isDeleteNoteModal={isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Blog Post" route="blog-post"></DeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title="Luminous-Ecommerce || Blog Post" />
);
