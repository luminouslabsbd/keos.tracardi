    ...
    return (
        <>
            ...
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                <div className="rounded-full  bg-[#ff6243] p-1.5 text-white ring-2 ring-primary/30 ltr:mr-3 rtl:ml-3 bg-[#ff6243] h-[35px] w-[35px] flex items-center justify-center border-none">
                    <svg
                        width="27"
                        height="27"
                        viewBox="0 0 24 24"
                    ...
                    <div className="mb-5">
                        ...
                        >
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="btn btn-primary !mt-6 ml-auto border-none bg-[#ff6243]"
                                >
                                    Submit
                                </button>
                            </div>
