...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/brand/data', base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/brand/edit/"+data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/brand/status/"+data);
    }
    const ImageRenderer = ({ data }) => {
        return (
            <div>
                <img
                    src={data ? `/storage/brand/${data}` : '/assets/images/user-profile.jpeg'}
                    alt="image"
        ...
        <>
            ...
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/brand/trashed`}
                        method="get"
                    ...
                    <Link
                        href={`${base_url}/admin/brand/create`}
                        method="get"
            ...
            <DeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Brand" route="brand"></DeleteModal>
        </>
    );
}

Index.layout = (page) => (
    <MainLayout children={page} title="Brand List || Luminous-Ecommerce" />
);
