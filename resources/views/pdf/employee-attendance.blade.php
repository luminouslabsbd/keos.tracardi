      ...
      <table>
        ...
        @foreach($data->attendances as $item)
            <tr>
                ...
                <td class="desc">
                    @if($item->attendance_datetime != null && $item->entry_time < $item->shift_entry_time )
                        Present
                    @elseif($item->late_flag == 1 && $item->attendance_datetime != null)
                        Late
                    @elseif($item->attendance_datetime == null)
                        Absent
                    @elseif($item->holiday_flag == 0 && $item->offday_flag == 1 && $item->attendance_datetime == null)
                        Off Day
                    @elseif($item->holiday_flag == 1 && $item->offday_flag == 0)
                        Public holiday
                    @endif
                </td>
            </tr>
